        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CategoryKey = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    HoverImageUrl = table.Column<string>(type: "TEXT", nullable: true),
                    InspirationImageUrls = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
